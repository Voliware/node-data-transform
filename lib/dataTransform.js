...
class DataTransform extends Transform {
     ...
     * @param {String} action - what to do when a match is found
     * @param {Object} [contents=null]
     * @param {Buffer} [contents.buffer]
     * @param {String} [contents.string]
     * @param {String} [contents.file]
     * @returns {DataTransform}
     */
    modify(match, action, contents = null){
        ...
        if(typeof match === "string"){
            match = this.getStringAsCharChode(match);
        }
     ...
     * @param {Buffer} [modifier.contents.buffer] - a buffer of data
     * @param {String} [modifier.contents.file] - a readable file path
     * @param {String} [modifier.contents.string] - string data
     * @returns {DataTransform}
     */
    append(match, contents){
        return this.modify(match, "append", contents);
    }
     ...
     */
    compare(match){
        return this.modify(match, "compare");
    }
     ...
     */
    erase(match){
        return this.modify(match, "erase");
    }
    ...
    prepend(match, contents){
        return this.modify(match, "prepend", contents);
    }
    ...
    replace(match, contents){
        return this.modify(match, "replace", contents);
    }
     ...
     */
    split(match){
        return this.modify(match, "split");
    }
